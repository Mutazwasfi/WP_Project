...
$halloween_ends = '2023-11-05 23:59:59';
$halloween_efect = strtotime( '2023-10-24 00:00:01' ) < time() && time() < strtotime( $halloween_ends );
...
// Change timer.
$countdown_timer = $halloween_efect ? strtotime( $halloween_ends ) : $countdown_timer;

// Formatted data.
$data = [
	'counter_time' => $countdown_timer,
	'discount'     => $halloween_efect ? 40 : 35,
];
...
$modal_title = $halloween_efect ? __( 'Halloween deal you cannot miss!', 'wp-dark-mode' ) : $modal_title;
